...
const Button = ({ text, navigate }: button) => {
    ...
    return (
        <button onClick={handlePath} className="py-2 px-3 border text-[#2D0399] border-[#2D0399] rounded-xl group relative overflow-hidden active:scale-90 ease-linear transition-all ">
